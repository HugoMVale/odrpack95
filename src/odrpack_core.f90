...
contains
   ...
   !! distance regression (ODR) or ordinary linear or nonlinear least squares (OLS).
      ...
      real(kind=wp), external :: derstep
      external :: detaf, dfctrw, dflags, diniwk, diwinf, djck, dodchk, dodper, dpack, &
                  dsetn, dunpac, dwinf
...
50       if ((info .ne. 0) .or. &
   ...
   subroutine dodmn &
      ...
      ! External ODRPACK procedures
      ! @todo: place in module
      external :: dacces, devjac, dflags, dodlm, dodpcr, dodvcv, dunpac
